...
window.ParsleyExtend = $.extend(window.ParsleyExtend, {
  ...
  _asyncIsValidField: function (force, value) {
    ...
    // Directly reject promise, do not run remote validator and req server load
...
( function ( exports ) {
  ...
  */
  ...
  var ParsleyField = function (field, OptionsFactory, parsleyFormInstance) {
    ...
    this.__id__ = ParsleyUtils.hash(4);
    this.$element = $(field);
    // If we have a parent `ParsleyForm` instance given, use its `OptionsFactory`, and req parent
