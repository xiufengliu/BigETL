!function($, wysi) {
    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "link":
                "<li>" +
                  "<div class='config-wysihtml5-insert-link-modal modal hide fade'>" +
                    "<div class='modal-header'>" +
                      "<a class='close' data-dismiss='modal'>&times;</a>" +
                      "<h3>" + locale.link.insert + "</h3>" +
                    "</div>" +
                    "<div class='modal-body'>" +
                      "<input value='http://' class='config-wysihtml5-insert-link-url input-xlarge'>" +
                    "</div>" +
            ...
            "image":
                "<li>" +
                  "<div class='config-wysihtml5-insert-image-modal modal hide fade'>" +
                    "<div class='modal-header'>" +
                      "<a class='close' data-dismiss='modal'>&times;</a>" +
                      "<h3>" + locale.image.insert + "</h3>" +
                    "</div>" +
                    "<div class='modal-body'>" +
                      "<input value='http://' class='config-wysihtml5-insert-image-url input-xlarge'>" +
                    "</div>" +
                    "<div class='modal-footer'>" +
