!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ""+
                "<div class='config-wysihtml5-insert-link-modal modal fade'>" +
                ...
                "<input value='http://' class='config-wysihtml5-insert-link-url form-control'>" +
                "<label class='checkbox'> <input type='checkbox' class='config-wysihtml5-insert-link-target' checked>" + locale.link.target + "</label>" +
                "</div>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
                "<div class='config-wysihtml5-insert-image-modal modal fade'>" +
                "<div class='modal-dialog'>"+
                "<div class='modal-content'>"+
                "<div class='modal-header'>" +
                "<a class='close' data-dismiss='modal'>&times;</a>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                "<input value='http://' class='config-wysihtml5-insert-image-url form-control'>" +
                "</div>" +
                "<div class='modal-footer'>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            var self = this;
            var insertImageModal = toolbar.find('.config-wysihtml5-insert-image-modal');
            var urlInput = insertImageModal.find('.config-wysihtml5-insert-image-url');
        ...
        initInsertLink: function(toolbar) {
            var self = this;
            var insertLinkModal = toolbar.find('.config-wysihtml5-insert-link-modal');
            var urlInput = insertLinkModal.find('.config-wysihtml5-insert-link-url');
            var targetInput = insertLinkModal.find('.config-wysihtml5-insert-link-target');
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        parserRules: {
            ...
            tags: {
                ...
                "span": 1,
                "div": 1,
                // to allow req and edit files with code tag hacks
                "code": 1,
                "pre": 1
            }
        },
