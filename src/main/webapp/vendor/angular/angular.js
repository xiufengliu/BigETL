 ...
 * @description
 *
 * Use this directive to **auto-config** an AngularJS application. The `ngApp` directive
 * designates the **root element** of the application and is typically placed near the root element
 * of the page - e.g. on the `<body>` or `<html>` tags.
 *
 * Only one AngularJS application can be auto-bootstrapped per HTML document. The first `ngApp`
 * found in the document will be used to define the root element to auto-config as an
 * application. To run multiple applications in an HTML document you must manually config them using
 ...
 *
 * `ngApp` is the easiest, and most common, way to config an application.
 *
 ...
 *
 * Note that Protractor based end-to-end tests cannot use this function to config manually.
...
function setupModuleLoader(window) {
  ...
  // We need to expose `angular.$$minErr` to modules such as `ngResource` that reference it during config
 ...
 */
var version = {
  full: '1.3.0-build.3077+sha.05791c0',    // all of these placeholder strings will be replaced by grunt's
 ...
 *          return count;
 *        },
 *        // Call this to req the tracked events to the trackingUrl
 *        req: function() {
...
var $AnimateProvider = ['$provide', function($provide) {
   ...
   * an animation. Upon config the classNameFilter value is not set at all and will
      ...
      function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
        ...
        if (controllerDirectives) {
          ...
          forEach(controllerDirectives, function(directive) {
            ...
            // Instead, we req the controllers for the element in a local hash and attach to .data
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *   according to the {@link angular.equals} function. To req the value of the object for
...
// config the system (before $parse is instantiated), for this reason we just have
 ...
 * @example
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
    ...
    <file name="glyphicons.css">
      @import url(//netdna.bootstrapcdn.com/config/3.0.0/css/config-glyphicons.css);
    </file>
    <file name="animations.css">
      .animate-show {
        line-height:20px;
...
var styleDirective = valueFn({
  ...
  //but we will rebind on config again.
  bindJQuery();
