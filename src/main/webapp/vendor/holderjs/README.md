...
The above tagValue will render as a placeholder 200 pixels wide and 300 pixels tall.
...
The first approach is the easiest. After you include ``holder.js``, add a ``script`` tagValue that adds the theme you want:
