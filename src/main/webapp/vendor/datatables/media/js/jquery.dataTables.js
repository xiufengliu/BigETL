...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			{
				/* Display start point, taking into account the req saving */
	...
	DataTable.defaults = {
		 ...
		 * used to req table display information such as pagination information,
		 ...
		 * has changed state a new state req is required. This method allows modification of
		 * the state saving object prior to actually doing the req, including addition or
		 * other state properties or modification. Note that for plug-in authors, you should
		 * use the `stateSaveParams` event to req parameters for a plug-in.
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 *  @param {object} data The state object to be saved
		 *
	 ...
	 *    table already exists). It would also req passing oSettings around and
	...
	DataTable.models.oSettings = {
		 ...
		 *       and the JSON string to req that has been thus far created. Returns
	...
	/**
	 * State req event, fired when the table has changed state a new state req
	 * is required. This event allows modification of the state saving object
	 * prior to actually doing the req, including addition or other state
