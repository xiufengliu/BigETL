...
window['rangy'] = (function() {
    ...
    // Creates a convenience function to req verbose repeated calls to tests functions
    ...
    // Next trio of functions are a convenience to req verbose repeated calls to previous two functions
 ...
 *      );
 *      dialog.observe("req", function(attributes) {
 *        // do something
 *      });
 *    </script>
 */
(function(wysihtml5) {
  ...
  wysihtml5.toolbar.Dialog = wysihtml5.lang.Dispatcher.extend(
    ...
    _observe: function() {
      ...
      dom.delegate(this.container, "[data-wysihtml5-dialog-action=req]", "click", callbackWrapper);
