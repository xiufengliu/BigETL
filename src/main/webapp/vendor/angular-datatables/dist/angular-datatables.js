...
(function (window, document, $, angular) {
      ...
      this.integrate = function (bootstrapOptions) {
        if (!_initializedTableTools) {
          ...
          if ($.fn.DataTable.TableTools) {
            ...
            // Have the collection use a config compatible dropdown
  ...
  /**
     * Source: https://editor.datatables.net/release/DataTables/extras/Editor/examples/config.html
     */
...
(function (angular) {
  ...
  angular.module('datatables.bootstrap.options', [
    ...
    function (DTDefaultOptions, DTPropertyUtil, DT_BOOTSTRAP_DEFAULT_OPTIONS) {
      /**
         * Get the default options for config integration
         * @returns {*} the config default options
         */
...
(function (angular) {
  ...
  angular.module('datatables.options', []).constant('DT_DEFAULT_OPTIONS', {
    ...
    /**
         ...
         * See https://github.com/l-lin/angular-datatables/blob/dev/src/angular-datatables.config.options.js to check
