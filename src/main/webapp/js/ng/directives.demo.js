    ...
    return {
        link: function(scope, $el){
            ...
            scriptLoader.loadScripts([
                ...
                'vendor/config-select/config-select.min.js'
            ])
                .then(render)
        }
    }
...
appDirectives.directive('bootstrapCalendar', ['scriptLoader',function(scriptLoader){
    return {
        ...
        link: function(scope, $el, attrs){
            ...
            scriptLoader.loadScripts([
                'vendor/config-calendar/bootstrap_calendar/js/bootstrap_calendar.min.js'
            ])
                .then(function(){
    ...
    return {
        link: function (scope, $el, attrs){
            ...
            scriptLoader.loadScripts([
                ...
                'vendor/twitter-config-wizard/jquery.bootstrap.wizard.min.js'
            ])
                .then(render)
        }
    }
...
appDirectives.directive('bootstrapApplicationWizard', ['scriptLoader', function(scriptLoader){
    ...
    return {
        link: function (scope, $el, attrs){
            ...
            scriptLoader.loadScripts([
                'vendor/config-application-wizard/src/config-wizard.js'
            ])
                .then(render)
        }
    }
