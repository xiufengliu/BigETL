...
singApp.value('uiJqDependencies', {
    ...
    'markdown': [
        ...
        'vendor/config-markdown/js/config-markdown.js'
    ],
    'datetimepicker': [
    ...
    'colorpicker': [
        'vendor/mjolnic-config-colorpicker/dist/js/config-colorpicker.min.js'
    ],
    'inputmask': [
        'vendor/jasny-config/js/inputmask.js'
    ],
    'fileinput': [
        'vendor/holderjs/holder.js',
        'vendor/jasny-config/js/fileinput.js'
    ],
    'slider': [
        'vendor/seiyria-config-slider/dist/config-slider.min.js'
    ],
    'parsley': [
