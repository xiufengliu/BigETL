...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emf.setPackagesToScan("dk.dtu.ccsd.core.domain");
    ...
    @Bean
    public HttpClient kairosdbClient() throws MalformedURLException {
        return new HttpClient(env.getProperty("kairosdb.url"));
    }
