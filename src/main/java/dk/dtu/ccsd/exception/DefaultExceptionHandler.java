...
public class DefaultExceptionHandler {
   ...
   // @RequestMapping(produces = {Versions.V1_0, Versions.V2_0})
    ...
    public @ResponseBody Map<String, Object> handleValidationException(MethodArgumentNotValidException ex) throws IOException {
        ...
        map.put("message", "Fields cannot be empty");
        map.put("errors", convertConstraintViolation(ex));
        return map;
    }
   ...
   // @RequestMapping(produces = {Versions.V1_0, Versions.V2_0})
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public @ResponseBody Map<String, Object> handleIOException(IOException ex) {
        Map<String, Object>  map = Maps.newHashMap();
        map.put("type", "IOException");
        map.put("message", ex.getCause().getMessage());
        return map;
    }

    @ExceptionHandler(CDMSException.class)
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public @ResponseBody Map<String, Object> handleCDMSException(CDMSException ex) {
        Map<String, Object>  map = Maps.newHashMap();
        map.put("type", "CDMSException");
        map.put("message", ex.getCause().getMessage());
        return map;
    }
    ...
    private List<Map<String, String>> convertConstraintViolation(MethodArgumentNotValidException ex) {
